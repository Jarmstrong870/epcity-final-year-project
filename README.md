...
Create a .env file within the epc-dashboard and backend folders with the following key names. Refer to the project's Gitlab CI/CD variables for the keys.
...
DATABASE_PORT=5432
DATABASE_PASSWORD=Dissertationteam4!
...
Key Tables:
users, properties, user_properties, inflatiom
