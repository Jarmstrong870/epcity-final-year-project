const translations = {
  ...
  pl: {
    ...
    description: 'Wpisz swój adres e-mail poniżej, a wyślemy Ci jednorazowy kod do zresetowania hasła.',
    placeholder: 'Wpisz swój e-mail',
    buttonSubmitting: 'Wysyłanie...',
    button: 'Wyślij jednorazowy kod',
    emailRequired: 'Proszę podać swój e-mail.',
    successMessage: 'Jeśli e-mail istnieje, wysłano link z jednorazowym kodem dostępu.',
    errorMessage: 'Wystąpił błąd. Spróbuj ponownie później.',
  },
  zh: {
    title: '忘记密码？',
    description: '请输入您的电子邮箱地址，我们将发送一次性验证码以重置您的密码。',
    placeholder: '输入您的电子邮箱',
    buttonSubmitting: '提交中...',
    button: '发送一次性验证码',
    emailRequired: '请输入您的电子邮箱。',
    successMessage: '如果电子邮箱存在，我们已发送一次性验证码的链接。',
