                ...
                <div className="property-info">
                  <p>
                    <strong>
                      ...
                      <Link
                        to={`/faq/glossary-page?searchTerm=${encodeURIComponent('address')}`}
                  ...
                  <p>
                    <strong>
                      <Link
                        to={`/faq/glossary-page?searchTerm=${encodeURIComponent('postcode')}`}
                        style={{ textDecoration: "none", color: "inherit" }}
                      >
                        <span className="green-question-mark"></span> {/* Green question mark generated by CSS */}
                      </Link>
                  ...
                  <p>
                    <strong>
                      <Link
                        to={`/faq/glossary-page?searchTerm=${encodeURIComponent('property type')}`}
                        style={{ textDecoration: "none", color: "inherit" }}
                      >
                        <span className="green-question-mark"></span> {/* Green question mark generated by CSS */}
                      </Link>
                  ...
                  <p>
                    <strong>
                      <Link
                        to={`/faq/glossary-page?searchTerm=${encodeURIComponent('number of bedrooms')}`}
                        style={{ textDecoration: "none", color: "inherit" }}
                      >
                        <span className="green-question-mark"></span> {/* Green question mark generated by CSS */}
                      </Link>
